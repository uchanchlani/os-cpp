...
void InterruptHandler::dispatch_interrupt(REGS * _r) {
  ...
  if(int_no == 0 && SYSTEM_SCHEDULER->is_interrupt_occured()) {
    return;
  }
...
void InterruptHandler::end_of_interrupt(unsigned int int_no) {/* Check if the interrupt was generated by the slave interrupt controller.
